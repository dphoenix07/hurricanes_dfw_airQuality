PRO OZONE_PDF_DAILYMAX_NORMALIZE, storm_type, $
	LANDFALL   = landfall, $
	ATLANTIC   = atlantic, $
	GULF	   = gulf, $
...
FOREACH year, yr_arr DO BEGIN
   ...
   ENDFOR  	
	...
	ts_arr_tot1   = [ts_arr_tot1  ,ts_arr  ]
   	o3_ns_arr = [o3_ns_arr,o3_nstorms]
	o3_s_arr=[o3_s_arr,o3_storms]
ENDFOREACH
...
;For entire o3 range
XYOUTS, 15.0, 13.50, 'No Storms = ' + STRTRIM(LONG(N_ELEMENTS(o3_ns_arr)),1), /DATA
XYOUTS, 15.0, 12.25, storm_label + STRTRIM(LONG(N_ELEMENTS(o3_s_arr)),1), COLOR = COLOR_24('red'), /DATA
...
pngfile = outdir + 'O3PDF_' + storm_type + '_' + basin +'_dailymax_normalize_JULY-NOV.png'
IF KEYWORD_SET(landfall) THEN pngfile = o3dir + 'timeseries_landfall_closest_storms_normalize.png'

epsfile = outdir + 'O3PDF_' + storm_type + '_' + basin +'_dailymax_excludebin1.eps'
epsfile = outdir + 'O3PDF_' + storm_type + '_' + basin +'_dailymax_normalize_JULY-NOV.eps'
IF KEYWORD_SET(landfall) THEN epsfile = o3dir + 'timeseries_landfall_closest_storms_normalize.eps'
