FUNCTION WIND_DALLAS_NAAQS, year, $
	PNG		  = png, $
	EPS		  = eps, $
	CLOBBER   = clobber
...
infile = indir + 'dallas_wind_' + year + '.csv'
...
CASE year OF 
	'1980' : BEGIN
            ...
            wind1 = data.field14[site1]
            wind2 = data.field14[site2]
	...
	'1986' : BEGIN
            ...
            wind2 = data.field14[site2]
            wind3 = data.field14[site3]
            wind4 = data.field14[site4]
            wind5 = data.field14[site5]
...
wind1_8hr = FLTARR(N_ELEMENTS(site1))
FOR tt = 0, N_ELEMENTS(site1)-9 DO BEGIN
	wind1_8hr[tt] = MEAN(wind1[tt:tt+8],/NAN)
ENDFOR
wind_hourly = [wind_hourly, wind1]
PRINT, 'Done calculating site 1'

wind2_8hr = FLTARR(N_ELEMENTS(site2))
FOR tt = 0, N_ELEMENTS(site2)-9 DO BEGIN
	wind2_8hr[tt] = MEAN(wind2[tt:tt+8],/NAN)
ENDFOR
wind_hourly = [wind_hourly, wind2]

PRINT, 'Done calculating site 2'

wind3_8hr = FLTARR(N_ELEMENTS(site3))
FOR tt = 0, N_ELEMENTS(site3)-9 DO BEGIN
	wind3_8hr[tt] = MEAN(wind3[tt:tt+8],/NAN)
ENDFOR
wind_hourly = [wind_hourly, wind3]
PRINT, 'Done calculating site 3'

wind_8hr_total = [wind1_8hr, wind2_8hr, wind3_8hr]

IF (N_ELEMENTS(site4) GT 0) THEN BEGIN
    wind4_8hr = FLTARR(N_ELEMENTS(site4))
    FOR tt = 0, N_ELEMENTS(site4)-9 DO BEGIN
    	wind4_8hr[tt] = MEAN(wind4[tt:tt+8],/NAN)
    ENDFOR   
    PRINT, 'Done calculating site 4'
wind_8hr_total = [wind_8hr_total, wind4_8hr]
wind_hourly = [wind_hourly, wind4]
ENDIF

IF (N_ELEMENTS(site5) GT 0) THEN BEGIN
    wind5_8hr = FLTARR(N_ELEMENTS(site5))
    FOR tt = 0, N_ELEMENTS(site5)-9 DO BEGIN
    	wind5_8hr[tt] = MEAN(wind5[tt:tt+8],/NAN)
    ENDFOR   
    PRINT, 'Done calculating site 5'
wind_8hr_total = [wind_8hr_total, wind5_8hr]
wind_hourly = [wind_hourly, wind5]
ENDIF

IF (N_ELEMENTS(site6) GT 0) THEN BEGIN
    wind6_8hr = FLTARR(N_ELEMENTS(site6))
    FOR tt = 0, N_ELEMENTS(site6)-9 DO BEGIN
    	wind6_8hr[tt] = MEAN(wind6[tt:tt+8],/NAN)
    ENDFOR   
    PRINT, 'Done calculating site 6'
wind_8hr_total = [wind_8hr_total, wind6_8hr]
wind_hourly = [wind_hourly, wind6]
ENDIF

IF (N_ELEMENTS(site7) GT 0) THEN BEGIN
    wind7_8hr = FLTARR(N_ELEMENTS(site7))
    FOR tt = 0, N_ELEMENTS(site7)-9 DO BEGIN
    	wind7_8hr[tt] = MEAN(wind7[tt:tt+8],/NAN)
    ENDFOR   
    PRINT, 'Done calculating site 7'
wind_8hr_total = [wind_8hr_total, wind7_8hr]
wind_hourly = [wind_hourly, wind7]
ENDIF

;Return, wind_8hr_total
...
FOR i = 0 , nt-1, 24 DO BEGIN
	indices=[]
   	...
   	ENDFOR
	;Find daily max wind
	wind_daily_max = [wind_daily_max, [MAX(wind_8hr_total[indices],/NAN), $
		MAX(wind_8hr_total[indices],/NAN), MAX(wind_8hr_total[indices],/NAN), $
		MAX(wind_8hr_total[indices],/NAN)]]
	wind_datestr = [wind_datestr, [time_arr[i],time_arr[i+6],time_arr[i+12],time_arr[i+18]]]
ENDFOR


RETURN, {wind_daily_max 		: wind_daily_max, $
				wind_datestr 	: wind_datestr, $
				wind_8hr_total : wind_8hr_total, $
