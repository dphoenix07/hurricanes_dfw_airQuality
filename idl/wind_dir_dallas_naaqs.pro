FUNCTION WIND_DIR_DALLAS_NAAQS, year, $
	PNG		  = png, $
	EPS		  = eps, $
	CLOBBER   = clobber
...
;     DIRECTORY : Output directory for wind_dir file.
...
infile = indir + 'dallas_wind_dir_' + year + '.csv'
...
CASE year OF 
	'1980' : BEGIN
            ...
            wind_dir1 = data.field14[site1]
            wind_dir2 = data.field14[site2]
	...
	'1986' : BEGIN
            ...
            wind_dir2 = data.field14[site2]
            wind_dir3 = data.field14[site3]
            wind_dir4 = data.field14[site4]
            wind_dir5 = data.field14[site5]
...
wind_dir1_8hr = FLTARR(N_ELEMENTS(site1))
FOR tt = 0, N_ELEMENTS(site1)-9 DO BEGIN
	wind_dir1_8hr[tt] = MEAN(wind_dir1[tt:tt+8],/NAN)
ENDFOR
wind_dir_hourly = [wind_dir_hourly, wind_dir1]
wind_dir_8hr_total = [wind_dir1_8hr]
PRINT, 'Done calculating site 1'

wind_dir2_8hr = FLTARR(N_ELEMENTS(site2))
FOR tt = 0, N_ELEMENTS(site2)-9 DO BEGIN
	wind_dir2_8hr[tt] = MEAN(wind_dir2[tt:tt+8],/NAN)
ENDFOR
wind_dir_hourly = [wind_dir_hourly, wind_dir2]
wind_dir_8hr_total = [wind_dir1_8hr, wind_dir2_8hr]

PRINT, 'Done calculating site 2'

IF (N_ELEMENTS(site3) GT 0) THEN BEGIN
    wind_dir3_8hr = FLTARR(N_ELEMENTS(site3))
    FOR tt = 0, N_ELEMENTS(site3)-9 DO BEGIN
    	wind_dir3_8hr[tt] = MEAN(wind_dir3[tt:tt+8],/NAN)
    ENDFOR
    wind_dir_hourly = [wind_dir_hourly, wind_dir3]
    PRINT, 'Done calculating site 3'
    
    wind_dir_8hr_total = [wind_dir1_8hr, wind_dir2_8hr, wind_dir3_8hr]
ENDIF

IF (N_ELEMENTS(site4) GT 0) THEN BEGIN
    wind_dir4_8hr = FLTARR(N_ELEMENTS(site4))
    FOR tt = 0, N_ELEMENTS(site4)-9 DO BEGIN
    	wind_dir4_8hr[tt] = MEAN(wind_dir4[tt:tt+8],/NAN)
    ENDFOR   
    PRINT, 'Done calculating site 4'
wind_dir_8hr_total = [wind_dir_8hr_total, wind_dir4_8hr]
wind_dir_hourly = [wind_dir_hourly, wind_dir4]
ENDIF

IF (N_ELEMENTS(site5) GT 0) THEN BEGIN
    wind_dir5_8hr = FLTARR(N_ELEMENTS(site5))
    FOR tt = 0, N_ELEMENTS(site5)-9 DO BEGIN
    	wind_dir5_8hr[tt] = MEAN(wind_dir5[tt:tt+8],/NAN)
    ENDFOR   
    PRINT, 'Done calculating site 5'
wind_dir_8hr_total = [wind_dir_8hr_total, wind_dir5_8hr]
wind_dir_hourly = [wind_dir_hourly, wind_dir5]
ENDIF

IF (N_ELEMENTS(site6) GT 0) THEN BEGIN
    wind_dir6_8hr = FLTARR(N_ELEMENTS(site6))
    FOR tt = 0, N_ELEMENTS(site6)-9 DO BEGIN
    	wind_dir6_8hr[tt] = MEAN(wind_dir6[tt:tt+8],/NAN)
    ENDFOR   
    PRINT, 'Done calculating site 6'
wind_dir_8hr_total = [wind_dir_8hr_total, wind_dir6_8hr]
wind_dir_hourly = [wind_dir_hourly, wind_dir6]
ENDIF

IF (N_ELEMENTS(site7) GT 0) THEN BEGIN
    wind_dir7_8hr = FLTARR(N_ELEMENTS(site7))
    FOR tt = 0, N_ELEMENTS(site7)-9 DO BEGIN
    	wind_dir7_8hr[tt] = MEAN(wind_dir7[tt:tt+8],/NAN)
    ENDFOR   
    PRINT, 'Done calculating site 7'
wind_dir_8hr_total = [wind_dir_8hr_total, wind_dir7_8hr]
wind_dir_hourly = [wind_dir_hourly, wind_dir7]
ENDIF

;Return, wind_dir_8hr_total
...
FOR i = 0 , nt-1, 24 DO BEGIN
	indices=[]
   	FOR hh=0,23 DO BEGIN
   		...
   		indices = [indices, io3]
   	ENDFOR
	;Find daily max wind_dir
	wind_dir_daily_max = [wind_dir_daily_max, [MAX(wind_dir_8hr_total[indices],/NAN), $
		MAX(wind_dir_8hr_total[indices],/NAN), MAX(wind_dir_8hr_total[indices],/NAN), $
		MAX(wind_dir_8hr_total[indices],/NAN)]]
	wind_dir_datestr = [wind_dir_datestr, [time_arr[i],time_arr[i+6],time_arr[i+12],time_arr[i+18]]]
ENDFOR


RETURN, {wind_dir_daily_max 		: wind_dir_daily_max, $
				wind_dir_datestr 	: wind_dir_datestr, $
				wind_dir_8hr_total  : wind_dir_8hr_total, $
				wind_dir_hourly		: wind_dir_hourly, $
				date            : data.field12, $
				time			: data.field13}
