PRO PLOT_CHEM_MET_OBS_ANOMALIES, startmonth, $
	PNG		  = png, $
	EPS		  = eps, $
	CLOBBER   = clobber
...
outfile = 'hourly_anomalies_072005_122017.nc'
...
NCDF_ATTPUT, oid, 'Temperature', 'long_name', 'Temperature storm anomalies 7/2005-12/2017'														;Name attribute
...
NCDF_ATTPUT, oid, 'Wind_Speed', 'long_name', 'Wind Speed storm anomalies 7/2005-12/2017'														;Name attribute
...
NCDF_ATTPUT, oid, 'Wind_Direction', 'long_name', 'Wind Direction storm anomalies 7/2005-12/2017' 											;Name attribute
...
NCDF_ATTPUT, oid, 'Pressure', 'long_name', 'Pressure storm anomalies 7/2005-12/2017'											;Name attribute
NCDF_ATTPUT, oid, 'Pressure', 'units',     'hPa'																	;Units attribute

vid = NCDF_VARDEF(oid, 'RH_anomaly', [tid], /FLOAT)												;Define the latitude variable
NCDF_ATTPUT, oid, 'RH', 'long_name', 'Relative Humidity storm anomalies 7/2005-12/2017'									;Name attribute
NCDF_ATTPUT, oid, 'RH', 'units',     '%'												;Units attribute

vid = NCDF_VARDEF(oid, 'Dew_Point_anomaly', [tid], /FLOAT)												;Define the latitude variable
NCDF_ATTPUT, oid, 'Dew_Point', 'long_name', 'Dew Point Temperature storm anomalies 7/2005-12/2017'									;Name attribute
NCDF_ATTPUT, oid, 'Dew_Point', 'units',     'degrees F'												;Units attribute

tid = NCDF_DIMDEF(oid, 'Hours', SIZE(o3_narray, /DIMENSIONS))																		;Define output dimensions in netCDF file

vid = NCDF_VARDEF(oid, 'O3_nanomaly', [tid], /FLOAT)												;Define the longitude variable
NCDF_ATTPUT, oid, 'O3', 'long_name', 'O3 no-storm anomalies 7/2005-12/2017'								;Name attribute
NCDF_ATTPUT, oid, 'O3', 'units',     'ppb'												;Units attribute

vid = NCDF_VARDEF(oid, 'VOC_nanomaly', [tid], /FLOAT)												;Define the longitude variable
NCDF_ATTPUT, oid, 'VOC', 'long_name', 'VOC no-storm anomalies 7/2005-12/2017'								;Name attribute
NCDF_ATTPUT, oid, 'VOC', 'units',     'ppb'												;Units attribute

vid = NCDF_VARDEF(oid, 'PM2.5_nanomaly', [tid], /FLOAT)												;Define the latitude variable
NCDF_ATTPUT, oid, 'PM2.5', 'long_name', 'PM 2.5 no-storm anomalies 7/2005-12/2017'									;Name attribute
NCDF_ATTPUT, oid, 'PM2.5', 'units',     'ppb'												;Units attribute

vid = NCDF_VARDEF(oid, 'NOx_nanomaly', [tid], /FLOAT)												;Define the latitude variable
NCDF_ATTPUT, oid, 'NOx', 'long_name', 'NOy no-storm anomalies 7/2005-12/2017'									;Name attribute
NCDF_ATTPUT, oid, 'NOx', 'units',     'ppb'												;Units attribute

vid = NCDF_VARDEF(oid, 'CO_nanomaly', [tid], /FLOAT)												;Define the latitude variable
NCDF_ATTPUT, oid, 'CO', 'long_name', 'CO no-storm anomalies 7/2005-12/2017'									;Name attribute
NCDF_ATTPUT, oid, 'CO', 'units',     'ppb'												;Units attribute

vid = NCDF_VARDEF(oid, 'Temperature_nanomaly', [tid], /FLOAT)													;Define the pressure variable
NCDF_ATTPUT, oid, 'Temperature', 'long_name', 'Temperature no-storm anomalies 7/2005-12/2017'														;Name attribute
NCDF_ATTPUT, oid, 'Temperature', 'units',     'degrees F'																	;Units attribute

vid = NCDF_VARDEF(oid, 'Wind_Speed_nanomaly', [tid], /FLOAT)													;Define the pressure variable
NCDF_ATTPUT, oid, 'Wind_Speed', 'long_name', 'Wind Speed no-storm anomalies 7/2005-12/2017'														;Name attribute
NCDF_ATTPUT, oid, 'Wind_Speed', 'units',     'Knots'																	;Units attribute

vid = NCDF_VARDEF(oid, 'Wind_Direction_nanomaly', [tid], /FLOAT)													;Define the geopotential height variable
NCDF_ATTPUT, oid, 'Wind_Direction', 'long_name', 'Wind Direction no-storm anomalies 7/2005-12/2017' 											;Name attribute
NCDF_ATTPUT, oid, 'Wind_Direction', 'units',     'Degrees Compass'																	;Units attribute

vid = NCDF_VARDEF(oid, 'Pressure_nanomaly', [tid], /FLOAT)													;Define the geopotential height variable
NCDF_ATTPUT, oid, 'Pressure', 'long_name', 'Pressure no-storm anomalies 7/2005-12/2017'											;Name attribute
NCDF_ATTPUT, oid, 'Pressure', 'units',     'hPa'																	;Units attribute

vid = NCDF_VARDEF(oid, 'RH_nanomaly', [tid], /FLOAT)												;Define the latitude variable
NCDF_ATTPUT, oid, 'RH', 'long_name', 'Relative Humidity no-storm anomalies 7/2005-12/2017'									;Name attribute
NCDF_ATTPUT, oid, 'RH', 'units',     '%'												;Units attribute

vid = NCDF_VARDEF(oid, 'Dew_Point_nanomaly', [tid], /FLOAT)												;Define the latitude variable
NCDF_ATTPUT, oid, 'Dew_Point', 'long_name', 'Dew Point Temperature no-storm anomalies 7/2005-12/2017'									;Name attribute
NCDF_ATTPUT, oid, 'Dew_Point', 'units',     'degrees F'												;Units attribute

tid = NCDF_DIMDEF(oid, 'Hours', SIZE(o3_storm, /DIMENSIONS))																		;Define output dimensions in netCDF file

vid = NCDF_VARDEF(oid, 'O3_storm', [tid], /FLOAT)												;Define the longitude variable
NCDF_ATTPUT, oid, 'O3', 'long_name', 'O3 storm concentration 7/2005-12/2017'								;Name attribute
NCDF_ATTPUT, oid, 'O3', 'units',     'ppb'												;Units attribute

vid = NCDF_VARDEF(oid, 'VOC_storm', [tid], /FLOAT)												;Define the longitude variable
NCDF_ATTPUT, oid, 'VOC', 'long_name', 'VOC storm concentration 7/2005-12/2017'								;Name attribute
NCDF_ATTPUT, oid, 'VOC', 'units',     'ppb'												;Units attribute

vid = NCDF_VARDEF(oid, 'PM2.5_storm', [tid], /FLOAT)												;Define the latitude variable
NCDF_ATTPUT, oid, 'PM2.5', 'long_name', 'PM 2.5 storm concentration 7/2005-12/2017'									;Name attribute
NCDF_ATTPUT, oid, 'PM2.5', 'units',     'ppb'												;Units attribute

vid = NCDF_VARDEF(oid, 'NOx_storm', [tid], /FLOAT)												;Define the latitude variable
NCDF_ATTPUT, oid, 'NOx', 'long_name', 'NOy storm concentration 7/2005-12/2017'									;Name attribute
NCDF_ATTPUT, oid, 'NOx', 'units',     'ppb'												;Units attribute

vid = NCDF_VARDEF(oid, 'CO_storm', [tid], /FLOAT)												;Define the latitude variable
NCDF_ATTPUT, oid, 'CO', 'long_name', 'CO storm concentration 7/2005-12/2017'									;Name attribute
NCDF_ATTPUT, oid, 'CO', 'units',     'ppb'												;Units attribute

vid = NCDF_VARDEF(oid, 'Temperature_storm', [tid], /FLOAT)													;Define the pressure variable
NCDF_ATTPUT, oid, 'Temperature', 'long_name', 'Temperature storm 7/2005-12/2017'														;Name attribute
NCDF_ATTPUT, oid, 'Temperature', 'units',     'degrees F'																	;Units attribute

vid = NCDF_VARDEF(oid, 'Wind_Speed_storm', [tid], /FLOAT)													;Define the pressure variable
NCDF_ATTPUT, oid, 'Wind_Speed', 'long_name', 'Wind Speed storm 7/2005-12/2017'														;Name attribute
NCDF_ATTPUT, oid, 'Wind_Speed', 'units',     'Knots'																	;Units attribute

vid = NCDF_VARDEF(oid, 'Wind_Direction_storm', [tid], /FLOAT)													;Define the geopotential height variable
NCDF_ATTPUT, oid, 'Wind_Direction', 'long_name', 'Wind Direction storm 7/2005-12/2017' 											;Name attribute
NCDF_ATTPUT, oid, 'Wind_Direction', 'units',     'Degrees Compass'																	;Units attribute

vid = NCDF_VARDEF(oid, 'Pressure_storm', [tid], /FLOAT)													;Define the geopotential height variable
NCDF_ATTPUT, oid, 'Pressure', 'long_name', 'Pressure storm 7/2005-12/2017'											;Name attribute
NCDF_ATTPUT, oid, 'Pressure', 'units',     'hPa'																	;Units attribute

vid = NCDF_VARDEF(oid, 'RH_storm', [tid], /FLOAT)												;Define the latitude variable
NCDF_ATTPUT, oid, 'RH', 'long_name', 'Relative Humidity storm 7/2005-12/2017'									;Name attribute
NCDF_ATTPUT, oid, 'RH', 'units',     '%'												;Units attribute

vid = NCDF_VARDEF(oid, 'Dew_Point_storm', [tid], /FLOAT)												;Define the latitude variable
NCDF_ATTPUT, oid, 'Dew_Point', 'long_name', 'Dew Point Temperature storm 7/2005-12/2017'									;Name attribute
NCDF_ATTPUT, oid, 'Dew_Point', 'units',     'degrees F'												;Units attribute

tid = NCDF_DIMDEF(oid, 'Hours', SIZE(o3_nstorm, /DIMENSIONS))																		;Define output dimensions in netCDF file

vid = NCDF_VARDEF(oid, 'O3_nstorm', [tid], /FLOAT)												;Define the longitude variable
NCDF_ATTPUT, oid, 'O3', 'long_name', 'O3 nstorm concentration 7/2005-12/2017'								;Name attribute
NCDF_ATTPUT, oid, 'O3', 'units',     'ppb'												;Units attribute

vid = NCDF_VARDEF(oid, 'VOC_nstorm', [tid], /FLOAT)												;Define the longitude variable
NCDF_ATTPUT, oid, 'VOC', 'long_name', 'VOC nstorm concentration 7/2005-12/2017'								;Name attribute
NCDF_ATTPUT, oid, 'VOC', 'units',     'ppb'												;Units attribute

vid = NCDF_VARDEF(oid, 'PM2.5_nstorm', [tid], /FLOAT)												;Define the latitude variable
NCDF_ATTPUT, oid, 'PM2.5', 'long_name', 'PM 2.5 nstorm concentration 7/2005-12/2017'									;Name attribute
NCDF_ATTPUT, oid, 'PM2.5', 'units',     'ppb'												;Units attribute

vid = NCDF_VARDEF(oid, 'NOx_nstorm', [tid], /FLOAT)												;Define the latitude variable
NCDF_ATTPUT, oid, 'NOx', 'long_name', 'NOy nstorm concentration 7/2005-12/2017'									;Name attribute
NCDF_ATTPUT, oid, 'NOx', 'units',     'ppb'												;Units attribute

vid = NCDF_VARDEF(oid, 'CO_nstorm', [tid], /FLOAT)												;Define the latitude variable
NCDF_ATTPUT, oid, 'CO', 'long_name', 'CO nstorm concentration 7/2005-12/2017'									;Name attribute
NCDF_ATTPUT, oid, 'CO', 'units',     'ppb'												;Units attribute

vid = NCDF_VARDEF(oid, 'Temperature_nstorm', [tid], /FLOAT)													;Define the pressure variable
NCDF_ATTPUT, oid, 'Temperature', 'long_name', 'Temperature nstorm 7/2005-12/2017'														;Name attribute
NCDF_ATTPUT, oid, 'Temperature', 'units',     'degrees F'																	;Units attribute

vid = NCDF_VARDEF(oid, 'Wind_Speed_nstorm', [tid], /FLOAT)													;Define the pressure variable
NCDF_ATTPUT, oid, 'Wind_Speed', 'long_name', 'Wind Speed nstorm 7/2005-12/2017'														;Name attribute
NCDF_ATTPUT, oid, 'Wind_Speed', 'units',     'Knots'																	;Units attribute

vid = NCDF_VARDEF(oid, 'Wind_Direction_nstorm', [tid], /FLOAT)													;Define the geopotential height variable
NCDF_ATTPUT, oid, 'Wind_Direction', 'long_name', 'Wind Direction nstorm 7/2005-12/2017' 											;Name attribute
NCDF_ATTPUT, oid, 'Wind_Direction', 'units',     'Degrees Compass'																	;Units attribute

vid = NCDF_VARDEF(oid, 'Pressure_nstorm', [tid], /FLOAT)													;Define the geopotential height variable
NCDF_ATTPUT, oid, 'Pressure', 'long_name', 'Pressure nstorm 7/2005-12/2017'											;Name attribute
NCDF_ATTPUT, oid, 'Pressure', 'units',     'hPa'																	;Units attribute

vid = NCDF_VARDEF(oid, 'RH_nstorm', [tid], /FLOAT)												;Define the latitude variable
NCDF_ATTPUT, oid, 'RH', 'long_name', 'Relative Humidity nstorm 7/2005-12/2017'									;Name attribute
NCDF_ATTPUT, oid, 'RH', 'units',     '%'												;Units attribute

vid = NCDF_VARDEF(oid, 'Dew_Point_nstorm', [tid], /FLOAT)												;Define the latitude variable
NCDF_ATTPUT, oid, 'Dew_Point', 'long_name', 'Dew Point Temperature nstorm 7/2005-12/2017'									;Name attribute
NCDF_ATTPUT, oid, 'Dew_Point', 'units',     'degrees F'												;Units attribute
