PRO PLOT_CHEM_MET_OBS_ANOMALIES_1996, startmonth, $
	PNG		  = png, $
	EPS		  = eps, $
	CLOBBER   = clobber
...
IF (N_ELEMENTS(startmonth) EQ 0) THEN startmonth = '071996'
...
imonth = WHERE(((ts_data.date.year GE '1996') AND (ts_data.date.year LT '2000')) AND $
	((ts_data.date.month GE 07) AND (ts_data.date.month LT 08)) AND (ts_data.date.hour EQ 18))
...
yr_arr = ['1996','1997','1998','1999','2000']
...
FOREACH year, yr_arr DO BEGIN
    ...
    time_arr = [ ]
    date1 = MAKE_DATE(year,07,01,18,00)
    date2 = MAKE_DATE(year,08,01,18,00)
...
outfile = 'hourly_anomalies_071996_082000_JULY_18Z_HU.nc'
...
NCDF_ATTPUT, oid, 'O3_anomaly', 'long_name', 'O3 storm anomalies 1996-2000'								;Name attribute
...
NCDF_ATTPUT, oid, 'VOC_anomaly', 'long_name', 'VOC storm anomalies 1996-2000'								;Name attribute
...
;NCDF_ATTPUT, oid, 'PM2.5_anomaly', 'long_name', 'PM 2.5 storm anomalies 1996-2000'									;Name attribute
...
NCDF_ATTPUT, oid, 'NOx_anomaly', 'long_name', 'NOy storm anomalies 1996-2000'									;Name attribute
...
NCDF_ATTPUT, oid, 'CO_anomaly', 'long_name', 'CO storm anomalies 1996-2000'									;Name attribute
...
NCDF_ATTPUT, oid, 'Temperature_anomaly', 'long_name', 'Temperature storm anomalies 1996-2000'														;Name attribute
...
NCDF_ATTPUT, oid, 'Wind_Speed_anomaly', 'long_name', 'Wind Speed storm anomalies 1996-2000'														;Name attribute
...
NCDF_ATTPUT, oid, 'Wind_Direction_anomaly', 'long_name', 'Wind Direction storm anomalies 1996-2000' 											;Name attribute
...
;NCDF_ATTPUT, oid, 'Pressure_anomaly', 'long_name', 'Pressure storm anomalies 1996-2000'											;Name attribute
...
;NCDF_ATTPUT, oid, 'RH_anomaly', 'long_name', 'Relative Humidity storm anomalies 1996-2000'									;Name attribute
...
;NCDF_ATTPUT, oid, 'Dew_Point_anomaly', 'long_name', 'Dew Point Temperature storm anomalies 1996-2000'									;Name attribute
...
NCDF_ATTPUT, oid, 'O3_nanomaly', 'long_name', 'O3 no-storm anomalies 1996-2000'								;Name attribute
...
NCDF_ATTPUT, oid, 'VOC_nanomaly', 'long_name', 'VOC no-storm anomalies 1996-2000'								;Name attribute
...
;NCDF_ATTPUT, oid, 'PM2.5_nanomaly', 'long_name', 'PM 2.5 no-storm anomalies 1996-2000'									;Name attribute
...
NCDF_ATTPUT, oid, 'NOx_nanomaly', 'long_name', 'NOy no-storm anomalies 1996-2000'									;Name attribute
...
NCDF_ATTPUT, oid, 'CO_nanomaly', 'long_name', 'CO no-storm anomalies 1996-2000'									;Name attribute
...
NCDF_ATTPUT, oid, 'Temperature_nanomaly', 'long_name', 'Temperature no-storm anomalies 1996-2000'														;Name attribute
...
NCDF_ATTPUT, oid, 'Wind_Speed_nanomaly', 'long_name', 'Wind Speed no-storm anomalies 1996-2000'														;Name attribute
...
NCDF_ATTPUT, oid, 'Wind_Direction_nanomaly', 'long_name', 'Wind Direction no-storm anomalies 1996-2000' 											;Name attribute
...
;NCDF_ATTPUT, oid, 'Pressure_nanomaly', 'long_name', 'Pressure no-storm anomalies 1996-2000'											;Name attribute
...
;NCDF_ATTPUT, oid, 'RH_nanomaly', 'long_name', 'Relative Humidity no-storm anomalies 1996-2000'									;Name attribute
...
;NCDF_ATTPUT, oid, 'Dew_Point_nanomaly', 'long_name', 'Dew Point Temperature no-storm anomalies 1996-2000'									;Name attribute
...
NCDF_ATTPUT, oid, 'O3_storm', 'long_name', 'O3 storm concentration 1996-2000'								;Name attribute
...
NCDF_ATTPUT, oid, 'VOC_storm', 'long_name', 'VOC storm concentration 1996-2000'								;Name attribute
...
;NCDF_ATTPUT, oid, 'PM2.5_storm', 'long_name', 'PM 2.5 storm concentration 1996-2000'									;Name attribute
...
NCDF_ATTPUT, oid, 'Temperature_storm', 'long_name', 'Temperature storm 1996-2000'														;Name attribute
...
NCDF_ATTPUT, oid, 'Wind_Speed_storm', 'long_name', 'Wind Speed storm 1996-2000'														;Name attribute
...
NCDF_ATTPUT, oid, 'Wind_Direction_storm', 'long_name', 'Wind Direction storm 1996-2000' 											;Name attribute
...
;NCDF_ATTPUT, oid, 'Pressure_storm', 'long_name', 'Pressure storm 1996-2000'											;Name attribute
...
;NCDF_ATTPUT, oid, 'RH_storm', 'long_name', 'Relative Humidity storm 1996-2000'									;Name attribute
;NCDF_ATTPUT, oid, 'RH_storm', 'units',     '%'												;Units attribute
;
;vid = NCDF_VARDEF(oid, 'Dew_Point_storm', [tid], /FLOAT)												;Define the latitude variable
;NCDF_ATTPUT, oid, 'Dew_Point_storm', 'long_name', 'Dew Point Temperature storm 1996-2000'									;Name attribute
...
NCDF_ATTPUT, oid, 'O3_nstorm', 'long_name', 'O3 nstorm concentration 1996-2000'								;Name attribute
...
NCDF_ATTPUT, oid, 'VOC_nstorm', 'long_name', 'VOC nstorm concentration 1996-2000'								;Name attribute
...
;NCDF_ATTPUT, oid, 'PM2.5_nstorm', 'long_name', 'PM 2.5 nstorm concentration 1996-2000'									;Name attribute
...
NCDF_ATTPUT, oid, 'Temperature_nstorm', 'long_name', 'Temperature nstorm 1996-2000'														;Name attribute
...
NCDF_ATTPUT, oid, 'Wind_Speed_nstorm', 'long_name', 'Wind Speed nstorm 1996-2000'														;Name attribute
...
NCDF_ATTPUT, oid, 'Wind_Direction_nstorm', 'long_name', 'Wind Direction nstorm 1996-2000' 											;Name attribute
...
;NCDF_ATTPUT, oid, 'Pressure_nstorm', 'long_name', 'Pressure nstorm 1996-2000'											;Name attribute
...
;NCDF_ATTPUT, oid, 'RH_nstorm', 'long_name', 'Relative Humidity nstorm 1996-2000'									;Name attribute
...
;NCDF_ATTPUT, oid, 'Dew_Point_nstorm', 'long_name', 'Dew Point Temperature nstorm 1996-2000'									;Name attribute
