PRO MAKE_STORM_CHARACTERISTIC_FILE, $
	PNG		  = png, $
	EPS		  = eps, $
	CLOBBER   = clobber
...
;+
;NAME:
;     MAKE_STORM_CHARACTERISTIC_FILE
;PURPOSE:
...
;CALLING SEQUENCE:
;     MAKE_STORM_CHARACTERISTIC_FILE, date0, outfile
;INPUT:
...
years  = STRMID(MAKE_ISO_DATE_STRING(ts_data.date[ts_data.istart]),0,4) 
months = STRMID(MAKE_ISO_DATE_STRING(ts_data.date[ts_data.istart]),5,2) 
days   = STRMID(MAKE_ISO_DATE_STRING(ts_data.date[ts_data.istart]),8,2) 
hours  = STRMID(MAKE_ISO_DATE_STRING(ts_data.date[ts_data.istart]),11,2)
start_storm = years+months+days+hours+'00'

years  = STRMID(MAKE_ISO_DATE_STRING(ts_data.date[ts_data.iend]),0,4) 
months = STRMID(MAKE_ISO_DATE_STRING(ts_data.date[ts_data.iend]),5,2) 
days   = STRMID(MAKE_ISO_DATE_STRING(ts_data.date[ts_data.iend]),8,2) 
hours  = STRMID(MAKE_ISO_DATE_STRING(ts_data.date[ts_data.iend]),11,2)
end_storm = years+months+days+hours+'00'
...
outfile = 'hourly_anomalies_082005_092017_AUG_18Z.nc'
...
NCDF_ATTPUT, oid, 'O3_anomaly', 'long_name', 'O3 storm anomalies 08/2005-09/2017'								;Name attribute
...
NCDF_ATTPUT, oid, 'VOC_anomaly', 'long_name', 'VOC storm anomalies 08/2005-09/2017'								;Name attribute
...
NCDF_ATTPUT, oid, 'PM2.5_anomaly', 'long_name', 'PM 2.5 storm anomalies 08/2005-09/2017'									;Name attribute
...
NCDF_ATTPUT, oid, 'NOx_anomaly', 'long_name', 'NOy storm anomalies 08/2005-09/2017'									;Name attribute
...
NCDF_ATTPUT, oid, 'CO_anomaly', 'long_name', 'CO storm anomalies 08/2005-09/2017'									;Name attribute
...
NCDF_ATTPUT, oid, 'Temperature_anomaly', 'long_name', 'Temperature storm anomalies 08/2005-09/2017'														;Name attribute
...
NCDF_ATTPUT, oid, 'Wind_Speed_anomaly', 'long_name', 'Wind Speed storm anomalies 08/2005-09/2017'														;Name attribute
...
NCDF_ATTPUT, oid, 'Wind_Direction_anomaly', 'long_name', 'Wind Direction storm anomalies 08/2005-09/2017' 											;Name attribute
...
NCDF_ATTPUT, oid, 'Pressure_anomaly', 'long_name', 'Pressure storm anomalies 08/2005-09/2017'											;Name attribute
...
NCDF_ATTPUT, oid, 'RH_anomaly', 'long_name', 'Relative Humidity storm anomalies 08/2005-09/2017'									;Name attribute
...
NCDF_ATTPUT, oid, 'Dew_Point_anomaly', 'long_name', 'Dew Point Temperature storm anomalies 08/2005-09/2017'									;Name attribute
...
NCDF_ATTPUT, oid, 'O3_nanomaly', 'long_name', 'O3 no-storm anomalies 08/2005-09/2017'								;Name attribute
...
NCDF_ATTPUT, oid, 'VOC_nanomaly', 'long_name', 'VOC no-storm anomalies 08/2005-09/2017'								;Name attribute
...
NCDF_ATTPUT, oid, 'PM2.5_nanomaly', 'long_name', 'PM 2.5 no-storm anomalies 08/2005-09/2017'									;Name attribute
...
NCDF_ATTPUT, oid, 'NOx_nanomaly', 'long_name', 'NOy no-storm anomalies 08/2005-09/2017'									;Name attribute
...
NCDF_ATTPUT, oid, 'CO_nanomaly', 'long_name', 'CO no-storm anomalies 08/2005-09/2017'									;Name attribute
...
NCDF_ATTPUT, oid, 'Temperature_nanomaly', 'long_name', 'Temperature no-storm anomalies 08/2005-09/2017'														;Name attribute
...
NCDF_ATTPUT, oid, 'Wind_Speed_nanomaly', 'long_name', 'Wind Speed no-storm anomalies 08/2005-09/2017'														;Name attribute
...
NCDF_ATTPUT, oid, 'Wind_Direction_nanomaly', 'long_name', 'Wind Direction no-storm anomalies 08/2005-09/2017' 											;Name attribute
...
NCDF_ATTPUT, oid, 'Pressure_nanomaly', 'long_name', 'Pressure no-storm anomalies 08/2005-09/2017'											;Name attribute
...
NCDF_ATTPUT, oid, 'RH_nanomaly', 'long_name', 'Relative Humidity no-storm anomalies 08/2005-09/2017'									;Name attribute
...
NCDF_ATTPUT, oid, 'Dew_Point_nanomaly', 'long_name', 'Dew Point Temperature no-storm anomalies 08/2005-09/2017'									;Name attribute
...
NCDF_ATTPUT, oid, 'O3_storm', 'long_name', 'O3 storm concentration 08/2005-09/2017'								;Name attribute
NCDF_ATTPUT, oid, 'O3_storm', 'units',     'ppb'												;Units attribute

vid = NCDF_VARDEF(oid, 'VOC_storm', [tid], /FLOAT)												;Define the longitude variable
NCDF_ATTPUT, oid, 'VOC_storm', 'long_name', 'VOC storm concentration 08/2005-09/2017'								;Name attribute
...
NCDF_ATTPUT, oid, 'PM2.5_storm', 'long_name', 'PM 2.5 storm concentration 08/2005-09/2017'									;Name attribute
...
NCDF_ATTPUT, oid, 'NOx_storm', 'long_name', 'NOx storm concentration 08/2005-09/2017'									;Name attribute
NCDF_ATTPUT, oid, 'NOx_storm', 'units',     'ppb'												;Units attribute

vid = NCDF_VARDEF(oid, 'NO_storm', [tid], /FLOAT)												;Define the latitude variable
NCDF_ATTPUT, oid, 'NO_storm', 'long_name', 'NO storm concentration 08/2005-09/2017'									;Name attribute
NCDF_ATTPUT, oid, 'NO_storm', 'units',     'ppb'												;Units attribute

vid = NCDF_VARDEF(oid, 'NO2_storm', [tid], /FLOAT)												;Define the latitude variable
NCDF_ATTPUT, oid, 'NO2_storm', 'long_name', 'NO2 storm concentration 08/2005-09/2017'									;Name attribute
NCDF_ATTPUT, oid, 'NO2_storm', 'units',     'ppb'												;Units attribute

vid = NCDF_VARDEF(oid, 'CO_storm', [tid], /FLOAT)												;Define the latitude variable
NCDF_ATTPUT, oid, 'CO_storm', 'long_name', 'CO storm concentration 08/2005-09/2017'									;Name attribute
...
NCDF_ATTPUT, oid, 'Temperature_storm', 'long_name', 'Temperature storm 08/2005-09/2017'														;Name attribute
...
NCDF_ATTPUT, oid, 'Wind_Speed_storm', 'long_name', 'Wind Speed storm 08/2005-09/2017'														;Name attribute
...
NCDF_ATTPUT, oid, 'Wind_Direction_storm', 'long_name', 'Wind Direction storm 08/2005-09/2017' 											;Name attribute
...
NCDF_ATTPUT, oid, 'Pressure_storm', 'long_name', 'Pressure storm 08/2005-09/2017'											;Name attribute
...
NCDF_ATTPUT, oid, 'RH_storm', 'long_name', 'Relative Humidity storm 08/2005-09/2017'									;Name attribute
NCDF_ATTPUT, oid, 'RH_storm', 'units',     '%'												;Units attribute

vid = NCDF_VARDEF(oid, 'Dew_Point_storm', [tid], /FLOAT)												;Define the latitude variable
NCDF_ATTPUT, oid, 'Dew_Point_storm', 'long_name', 'Dew Point Temperature storm 08/2005-09/2017'									;Name attribute
...
NCDF_ATTPUT, oid, 'O3_nstorm', 'long_name', 'O3 nstorm concentration 08/2005-09/2017'								;Name attribute
...
NCDF_ATTPUT, oid, 'VOC_nstorm', 'long_name', 'VOC nstorm concentration 08/2005-09/2017'								;Name attribute
...
NCDF_ATTPUT, oid, 'PM2.5_nstorm', 'long_name', 'PM 2.5 nstorm concentration 08/2005-09/2017'									;Name attribute
...
NCDF_ATTPUT, oid, 'NOx_nstorm', 'long_name', 'NOx nstorm concentration 08/2005-09/2017'									;Name attribute
NCDF_ATTPUT, oid, 'NOx_nstorm', 'units',     'ppb'												;Units attribute

vid = NCDF_VARDEF(oid, 'NO_nstorm', [tid], /FLOAT)												;Define the latitude variable
NCDF_ATTPUT, oid, 'NO_nstorm', 'long_name', 'NO nstorm concentration 08/2005-09/2017'									;Name attribute
NCDF_ATTPUT, oid, 'NO_nstorm', 'units',     'ppb'												;Units attribute

vid = NCDF_VARDEF(oid, 'NO2_nstorm', [tid], /FLOAT)												;Define the latitude variable
NCDF_ATTPUT, oid, 'NO2_nstorm', 'long_name', 'NO2 nstorm concentration 08/2005-09/2017'									;Name attribute
NCDF_ATTPUT, oid, 'NO2_nstorm', 'units',     'ppb'												;Units attribute

vid = NCDF_VARDEF(oid, 'CO_nstorm', [tid], /FLOAT)												;Define the latitude variable
NCDF_ATTPUT, oid, 'CO_nstorm', 'long_name', 'CO nstorm concentration 08/2005-09/2017'									;Name attribute
...
NCDF_ATTPUT, oid, 'Temperature_nstorm', 'long_name', 'Temperature nstorm 08/2005-09/2017'														;Name attribute
...
NCDF_ATTPUT, oid, 'Wind_Speed_nstorm', 'long_name', 'Wind Speed nstorm 08/2005-09/2017'														;Name attribute
...
NCDF_ATTPUT, oid, 'Wind_Direction_nstorm', 'long_name', 'Wind Direction nstorm 08/2005-09/2017' 											;Name attribute
...
NCDF_ATTPUT, oid, 'Pressure_nstorm', 'long_name', 'Pressure nstorm 08/2005-09/2017'											;Name attribute
...
NCDF_ATTPUT, oid, 'RH_nstorm', 'long_name', 'Relative Humidity nstorm 08/2005-09/2017'									;Name attribute
...
NCDF_ATTPUT, oid, 'Dew_Point_nstorm', 'long_name', 'Dew Point Temperature nstorm 08/2005-09/2017'									;Name attribute
